...
//     animateValue(setYears, 3, duration);
//     animateValue(setCountries, 5, duration);
//     animateValue(setClients, 50, duration);
//     animateValue(setProducts, 20, duration);
//   }, []);
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-xl md:text-2xl mb-8 text-blue-100 max-w-2xl">
                  Your trusted partner for export of sesame seeds, rice, mustard, and towels, 
                  and import of frames, carry bags, gowns, basketballs, portable chargers, and kids helmets and more.
                </p>
